	...
	return (
		<div className="space-y-8 md:space-y-12">
			...
			<div className="grid grid-cols-1 gap-6 md:gap-8 lg:grid-cols-12">
				...
				<section className="space-y-4 md:space-y-6 lg:col-span-8">
				...
				<aside className="space-y-4 md:space-y-6 lg:col-span-4">
					<h2 className="text-2xl font-bold text-foreground md:text-3xl">Trending Categories</h2>
					<div className="space-y-3 rounded-lg border border-border bg-card p-4 md:p-6">
						{categories.map((category) => (
							...
							>
								<span className="text-sm font-medium text-foreground group-hover:text-primary md:text-base">
